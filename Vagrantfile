...
Vagrant.configure("2") do |config|
 ...
 #  config.vm.provision "shell", inline: <<-SHELL
  ...
  #config.vm.network "forwarded_port", host_ip: "127.0.0.1", guest: 8880, host:8080
  ...
  #Update and upgrade the server packages.
    ...
    sudo locale-gen en_GB.# encoding: UTF-8
    #Install Python, SQLite and pip
    sudo apt-get install -y python3-dev sqlite3 python-pip
